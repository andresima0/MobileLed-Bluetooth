...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Aplicar o TextWatcher ao campo de entrada do MAC Address
        editTextMacAddress.addTextChangedListener(new MacAddressTextWatcher());
    ...
    private void disconnectBluetooth() {
        try {
            ...
            buttonConnect.setText("Connect via Bluetooth");
